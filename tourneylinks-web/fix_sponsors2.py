...
target = """           <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
           </div>"""

replacement = """           <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
               {sponsors.map((s, i) => {
